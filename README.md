...
| [PentHertz/urh-ng](https://github.com/PentHertz/urh-ng/pull/3) | Fix wrong int8 magnitude/demodulation on ARM (signed `char`) |
...
<details>
<summary><b>Open / in review</b> — 20+ PRs across ~15 more repos</summary>
